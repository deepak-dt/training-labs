...
sudo ovs-vsctl -- add-port $EXT_BRIDGE_NAME patchPortEx1 -- set interface patchPortEx1 type=patch options:peer=patchPortInt1 -- add-port br-int patchPortInt1 -- set interface patchPortInt1 type=patch  options:peer=patchPortEx1
...
sudo ovs-ofctl add-flow $EXT_BRIDGE_NAME action=NORMAL
